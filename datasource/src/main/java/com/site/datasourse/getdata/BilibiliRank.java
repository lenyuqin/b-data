...
public class BilibiliRank {
    ...
    public void getVideoRanklist() {
        ...
        bVideoRankService.saveBatch(videoRankList);
        bVideoDataService.saveBatch(videoDataList);
    }
    ...
    public void getPopular() {
        ...
        if (bPopularDataService.saveBatch(videoRankList) && bVideoHistoryService.saveOrUpdateBatch(historyHashSet)) {
            log.info("热门榜爬取成功");
        } else {
            log.error("热门榜保存失败");
        }
