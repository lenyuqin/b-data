layui.define(['table', 'laypage', 'jquery', 'element','flow'], function (exports) {
    "use strict";
    ...
    function createCard(item) {
        var card =
            '<div class="layui-col-md3 ew-datagrid-item" onclick="jumpUrl(this.id)" data-index="0" data-number="1" id=' + item.id + ' > ' +
            '<div class="project-list-item"> <img class="project-list-item-cover"  src="/admin/images/loading2.gif" lay-src="' + item.image + '"> ' +
            '<div class="project-list-item-body"> <h2>' + item.title + '</h2>' +
            ...
            '<div class="ew-head-list"><span class="time"> ' + item.views + '播放</span></div> </div> </div> </div> </div>'
